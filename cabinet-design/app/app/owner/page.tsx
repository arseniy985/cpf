    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card className="border-brand-error/20">
            <CardHeader className="flex flex-row items-center justify-between border-b border-[#E2E8F0] pb-4">
        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex gap-3">
                <div className="flex flex-col items-center justify-center bg-gray-50 rounded-xl p-2 min-w-[48px]">
              ...
              <div className="flex gap-3">
                <div className="flex flex-col items-center justify-center bg-brand-warning/10 rounded-xl p-2 min-w-[48px]">

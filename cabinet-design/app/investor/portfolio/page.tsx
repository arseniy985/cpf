...
export default function InvestorPortfolio() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters Bar */}
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-white p-4 border border-[#E2E8F0] rounded-sm">
      ...
      <div className="hidden md:block bg-white border border-[#E2E8F0] rounded-sm overflow-hidden">

            ...
            {services.map((service, i) => (
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <Button variant="ghost" size="icon" className="w-12 h-12 rounded-full border border-current opacity-50 group-hover:opacity-100 group-hover:bg-current group-hover:text-white transition-all">

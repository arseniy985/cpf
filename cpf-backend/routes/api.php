...
use App\Modules\Origination\Http\Controllers\OwnerActivityController;
use App\Modules\Origination\Http\Controllers\OwnerRoundController;
use App\Modules\Origination\Http\Controllers\OwnerTeamController;
...
use Illuminate\Support\Facades\Route;
    ...
    Route::middleware(['auth:sanctum', 'role.any:project_owner'])->prefix('owner')->group(function (): void {
        ...
        Route::get('organization/history', [OwnerActivityController::class, 'organization']);
        Route::post('onboarding/submit', [OwnerOnboardingController::class, 'submit']);
        Route::get('team', [OwnerTeamController::class, 'show']);
        ...
        Route::get('rounds/{round}/history', [OwnerActivityController::class, 'round']);
        ...
        Route::get('projects/{project}/history', [OwnerActivityController::class, 'project']);
